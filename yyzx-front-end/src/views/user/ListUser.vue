		...
		<el-container>
			<el-header>
				<div>
					<el-row :gutter="30">
						<el-col :span="7">
							<el-input placeholder="名称" v-model="queryParams.username" @clear="query" clearable
								size="large">
								<template #append>
...
import { listOutwardPage } from "@/api/outwardApi.js";
export default {
	computed: {
		indexMethod() {
	...
	methods: {
		...
		//api-查询护理项目(分页)
		getUserList() {
			listUserPage(this.queryParams).then(res => {
