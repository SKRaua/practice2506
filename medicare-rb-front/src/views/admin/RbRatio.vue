    ...
    <div class="common-layout">
        <el-container>
            <el-header>
                <el-row :gutter="30">
                    <el-col :span="7">
                        <el-input placeholder="请输入医院级别/人员类型查询" v-model="queryParams.keyword" @clear="query" clearable
...
const loadRatioList = async () => {
    condition.keyword = queryParams.keyword;
    condition.page = page.currentPage;
    try {
        const res = await getReimbursementRatioPage(condition);
        if (res.flag) {
